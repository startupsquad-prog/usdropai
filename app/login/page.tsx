      ...
      <div className="relative z-10 w-full max-w-5xl">
        <Card className="overflow-hidden border-blue-500/20 bg-slate-900/40 backdrop-blur-xl shadow-2xl">
          <CardContent className="grid p-0 md:grid-cols-2">
            {/* Illustration Section - Now on the left */}
            <div className="relative hidden md:flex items-center justify-center bg-gradient-to-br from-blue-900/50 to-slate-900/50 p-8 backdrop-blur-sm border-r border-blue-500/20">
              <div className="relative z-10 text-center space-y-6">
                ...
                <div className="relative w-full h-64 rounded-lg bg-gradient-to-br from-blue-800/30 to-blue-600/30 backdrop-blur-sm border border-blue-500/20 flex items-center justify-center overflow-hidden">
                  {/* Abstract shapes */}
                  <div className="absolute top-10 right-10 w-20 h-20 rounded-full bg-blue-500/20 blur-xl"></div>
                  <div className="absolute bottom-10 left-10 w-32 h-32 rounded-full bg-cyan-500/20 blur-xl"></div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-slate-300 text-sm">
                    Continue scaling your dropshipping empire with AI-powered insights.
                  </p>
                </div>
                ...
                <Field>
                  <div className="flex items-center gap-2">
                    <input
                      id="remember"
                      type="checkbox"
                      className="h-4 w-4 rounded border-blue-500/30 bg-slate-800/50 text-blue-600 focus:ring-blue-500"
                    />
                    <FieldLabel htmlFor="remember" className="text-sm text-slate-400 font-normal">
